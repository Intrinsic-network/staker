...
interface IIntrinsicStaker is IERC721Receiver, IMulticall {
    /// @param rewardToken The token being distributed as a reward
    /// @param pool The Intrinsic pool
    ...
    /// @notice The Intrinsic Factory
    function factory() external view returns (IIntrinsicFactory);
    ...
    /// @notice Withdraws a Intrinsic LP token `tokenId` from this contract to the recipient `to`
    ...
    /// @notice Event emitted when a Intrinsic LP token has been staked
    /// @param tokenId The unique identifier of an Intrinsic LP token
    /// @param liquidity The amount of liquidity staked
    /// @param incentiveId The incentive in which the token is staking
    event TokenStaked(uint256 indexed tokenId, bytes32 indexed incentiveId, uint128 liquidity);

    /// @notice Event emitted when a Intrinsic LP token has been unstaked
    /// @param tokenId The unique identifier of an Intrinsic LP token
    /// @param incentiveId The incentive in which the token is staking
