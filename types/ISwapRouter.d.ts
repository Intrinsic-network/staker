...
interface ISwapRouterInterface extends ethers.utils.Interface {
  functions: {
    ...
    'intrinsicSwapCallback(int256,int256,bytes)': FunctionFragment
  }
  ...
  encodeFunctionData(functionFragment: 'intrinsicSwapCallback', values: [BigNumberish, BigNumberish, BytesLike]): string
  ...
  decodeFunctionResult(functionFragment: 'intrinsicSwapCallback', data: BytesLike): Result
...
export class ISwapRouter extends Contract {
  ...
  functions: {
    ...
    'intrinsicSwapCallback(int256,int256,bytes)'(
      amount0Delta: BigNumberish,
      amount1Delta: BigNumberish,
      data: BytesLike,
      overrides?: Overrides
