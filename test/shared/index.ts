export * from './external/periphery/constants'
export * from './external/periphery/ticks'
export * from './external/periphery/tokenSort'
...
import { IIntrinsicPool, TestERC20 } from '../../typechain'
...
export const getSlot0 = async (pool: IIntrinsicPool) => {
  if (!pool.signer) {
...
export const getCurrentTick = async (pool: IIntrinsicPool): Promise<number> => (await getSlot0(pool)).tick
