...
export class ActorFixture {
  ...
  /* EOA that owns all Intrinsic-related contracts */

  /* EOA that mints and transfers WRBTC to test accounts */
  wrbtcOwner() {
    return this._getActor(WALLET_USER_INDEXES.WRBTC_OWNER)
  }
  ...
  intrinsicRootUser() {
    return this._getActor(WALLET_USER_INDEXES.Intrinsic_ROOT)
  }
  ...
  /* These EOAs trade in the intrinsic pools and incur fees */
  traderUser0() {
